...
const services = [
  {
    title: "Выживание",
    description:
      "Классический режим с уникальными механиками: кланы, экономика, кастомные биомы и события. Идеально для казуальных игроков!",
    mockup: "social",
  },
  {
    title: "PvP Арены",
    description:
      "Сражайся с другими игроками на специальных аренах. Рейтинговые бои, сезонные турниры и уникальные награды.",
    mockup: "google-ads",
  },
  {
    title: "Мини-игры",
    description: "Десятки мини-игр на любой вкус: от паркура до стратегий. Новые режимы добавляются каждый месяц!",
    mockup: "email",
  },
  {
    title: "Ролевые приключения",
    description:
      "Погрузись в RPG-режим с квестами, прокачкой персонажа и уникальными историями. Каждый выбор имеет значение.",
    mockup: "seo",
  },
  {
    title: "Статистика",
    description:
      "Отслеживай свой прогресс, достижения и место в рейтинге. Стань лучшим игроком ZeroTime!",
    mockup: "analytics",
  },
  {
    title: "Творческий режим",
    description:
      "Строй без ограничений на специальных участках. Лучшие постройки попадают в галерею сервера.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Защита гриферов" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Бесплатно" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Без лагов" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Режимы игры</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Каждый найдёт своё занятие на ZeroTime — от казуального выживания до хардкорных битв.
          </p>
        </motion.div>
